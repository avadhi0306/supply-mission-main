...
engine = Engine.create();
	...
	packageBody = Bodies.circle(410,220,50,packageBody_option);
//	groundBody = Bodies.rectangle(400,650,400,20,ground_option);
groundBody = Bodies.rectangle(width/2, 650, width, 150 , ground_option);
